...
async function userDataRequest(username) {
  return new Promise((resolve) => {
    fetch(`https://userinfo.anfgg.workers.dev/${username}`)
      .then((res) => res.json())
      .then((data) => {
...
async function rankDataRequest(encryptedId) {
  return new Promise((resolve) => {
    fetch(`https://rankinfo.anfgg.workers.dev/${encryptedId}`)
      .then((res) => res.json())
      .then((data) => {
        if (data.length === 2) {
          ...
          data.length === 1 &&
          data[0].queueType === "RANKED_SOLO_5x5"
        ) {
          ...
          data.length === 1 &&
          data[0].queueType === "RANKED_FLEX_5x5"
        ) {
          summonerData.rankData.rankSoloTier = data[0].tier;
          summonerData.rankData.rankSoloRank = data[0].rank;
          summonerData.rankData.rankSoloPoints = data[0].leaguePoints;
...
async function masteryDataRequest(encryptedId) {
  return new Promise((resolve) => {
    fetch(`https://masteryinfo.anfgg.workers.dev/${encryptedId}`)
      .then((res) => res.json())
      .then((data) => {
  ...
  resultBody.innerHTML =
    ...
    <div class="userInfoContainer">
        <div class="iconArea">
            ...
            <img src="http://ddragon.leagueoflegends.com/cdn/13.6.1/img/profileicon/${
        ...
        <div class="userArea">
            ...
            <div class="mostArea">
                <div class="mostChamp">
                    <img src="http://ddragon.leagueoflegends.com/cdn/13.6.1/img/champion/${
                      summonerData.masteryData.m1champEng
                    }.png" alt="mostChamp1" class="championProfile">
                    <ul>
                        <li><h3>${
                          summonerData.masteryData.m1champName
                        }</h3></li>
                        <li><h4>숙련레벨 ${
                          summonerData.masteryData.most1Level
                        }</h4></li>
                        <li><h4>숙련점수 ${summonerData.masteryData.most1Points
                          .toString()
                          .replace(/\B(?=(\d{3})+(?!\d))/g, ",")}점</h4></li>
                    </ul>
                </div>
                <div class="mostChamp">
                    <img src="http://ddragon.leagueoflegends.com/cdn/13.6.1/img/champion/${
                      summonerData.masteryData.m2champEng
                    }.png" alt="mostChamp2" class="championProfile">
                    <ul>
                        <li><h3>${
                          summonerData.masteryData.m2champName
                        }</h3></li>
                        <li><h4>숙련레벨 ${
                          summonerData.masteryData.most2Level
                        }</h4></li>
                        <li><h4>숙련점수 ${summonerData.masteryData.most2Points
                          .toString()
                          .replace(/\B(?=(\d{3})+(?!\d))/g, ",")}점</h4></li>
                    </ul>
                </div>
                <div class="mostChamp">
                    ...
                    }.png" alt="mostChamp3" class="championProfile">
                    <ul>
                        <li><h3>${
                          summonerData.masteryData.m3champName
                        }</h3></li>
                        <li><h4>숙련레벨 ${
                          summonerData.masteryData.most3Level
                        }</h4></li>
                        <li><h4>숙련점수 ${summonerData.masteryData.most3Points
                          .toString()
                          .replace(/\B(?=(\d{3})+(?!\d))/g, ",")}점</h4></li>
                    </ul>
                </div>
        ...
        <div class="rankArea">
            <div class="rankBox">
                <img src="./src/tier/${
                  summonerData.rankData.rankSoloTier
                }.png" alt="tierImg">
                <ul>
                    <li><h3>솔로랭크</h3></li>
                    <li><h4>${summonerData.rankData.rankSoloTier} ${
      summonerData.rankData.rankSoloRank
    }</h4> <h5>${summonerData.rankData.rankSoloPoints}점</h5></li>
                    <li><h5>${summonerData.rankData.rankSoloWin}승 ${
      summonerData.rankData.rankSoloLose
    }패 (${(
      100 *
      (summonerData.rankData.rankSoloWin /
        (summonerData.rankData.rankSoloWin +
          summonerData.rankData.rankSoloLose))
    ).toFixed(2)}%)</h5></li>
                </ul>
            ...
            <div class="rankBox">
                <img src="./src/tier/${
                  summonerData.rankData.rankFlexTier
                }.png" alt="tierImg">
                <ul>
                    <li><h3>자유랭크</h3></li>
                    <li><h4>${summonerData.rankData.rankFlexTier} ${
      summonerData.rankData.rankFlexRank
    }</h4> <h5>${summonerData.rankData.rankFlexPoints}점</h5></li>
                    <li><h5>${summonerData.rankData.rankFlexWin}승 ${
      summonerData.rankData.rankFlexLose
    }패 (${(
      100 *
      (summonerData.rankData.rankFlexWin /
        (summonerData.rankData.rankFlexWin +
          summonerData.rankData.rankFlexLose))
    ).toFixed(2)}%)</h5></li>
                </ul>
